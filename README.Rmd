...
handled mainly by tow `R6` classes used in server and corresponding functions 
...
input for questions with Likert-like scoring scale
  ...
  - *UI presentation*:
    ...
    knitr::include_graphics("vignettes/likertRadioButtons_w_ind.png")
    ```
    
    - **without indicator** - only meaning of *min* and *max*
    
    ```{r likertRadioButtons_wo_ind, echo = F, out.width = '522px', fig.align = "center"}
    knitr::include_graphics("vignettes/likertRadioButtons_wo_ind.png")
    ```
...
>For the time being, if you plan to use it outside of `quetzio_server` and update
