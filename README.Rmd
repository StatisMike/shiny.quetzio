...
You can preview the `pkgdown` generated website [here](https://statismike.github.io/shiny.quetzio/)

## Installation

You can install the development version of shiny.quetzio from [GitHub](https://github.com/) with:
